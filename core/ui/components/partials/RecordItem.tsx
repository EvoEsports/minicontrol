...
export default function RecordItem({ id = '', pos = '0 0', 'z-index': z = 1, size = '100 4', nickname = '', time = 0, rank = 0, highlight = false }) {
    ...
    return (
        <frame id={id} pos={pos} z-index="2">
            ...
            <label pos="2.5 -1.25" z-index="3" size="3.5 3" text={rank} scale="0.8" halign="center" valign="center" textsize="1" textfont={fonts.label} />

            <label pos="6 -1.75" z-index="1" size="22 2.25" text={nickname} scale="0.85" halign="left" valign="center2" textsize="1" textfont={fonts.label} />
            <label pos="33 -1.9" z-index="3" size="30 3" text={formattedTime} halign="center" valign="center2" textsize="0.6" textfont={fonts.label} />
